...
class TestsOrderHistory:
    ...
    def test_new_order_change_all_time_order(self, driver, create_and_delete_user):
    ...
    def test_new_order_change_day_time_order(self, driver, create_and_delete_user):
        user = HomePage(driver)
        api_user = create_and_delete_user
        user.go_to_site(URL_ORDER_LIST)
